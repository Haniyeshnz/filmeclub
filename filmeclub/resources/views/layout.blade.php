    ...
    <header>
        <div class="container-full">
            <div class="row">
                    ...
                    <div class="dropdown">
                        <a data-toggle="dropdown" href="#" class="user-area">
                            <div class="thumb">
                                ...
                                <!-- <img src="https://s.gravatar.com/سایت اواتار " alt=""> -->
                            </div>
                            <h2>{{auth()->user()->name}}</h2></h2>
                            <h3>25 اشتراک</h3>
                ...
                @endauth
                @guest
                <div class="col-lg-2 col-md-2 col-sml-3 hidden-xs hidden-sm ">
                    <a href="{{route('login.create')}}" class="btn btn-danger" style="padding: 13px">ورود</a>
                    <a href="{{route('register.create')}}" class="btn btn-danger" style="padding: 13px">ثبت نام</a>
                </div>
                @endguest
            </div><!-- // row -->
        </div><!-- // container-full -->
